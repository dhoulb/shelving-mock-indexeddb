	...
	class IDBObjectStore
	{
		...
		constructor(transaction, storeName)
		{
			...
			function put(value, key)
			{
				...
				// Clone.
				try { value = clone(value); } catch (err) { throw new DOMException('IDBObjectStore.put(): value must be JSON-friendly value (string, finite number, null, true, false, plain array, plain object)', 'DataCloneError') }
